(function () {
    ...
    w.CHAT = {
        ...
        updateSysMsg: function (o, action) {
            ...
            //插入在线人数和在线列表
            d.getElementById('onLineCounts').innerHTML = '当前共有' + onLineCounts + "人在线：" + userHtml;
        ...
        init: function (userName) {
            ...
            this.socket = io.connect('localhost:9200');  /* TODO 如果要部署到阿里云，这里要换成公网ip */
            //向服务器发送某用户已经登录了
            ...
            this.socket.on("message", function (obj) {
                ...
                var contentDiv = '<span class="content">' + obj.content + '</span>';
                var userNameDiv = '<div class="chatter">' + obj.userName + '</div>';
                var section = d.createElement('section');
                if (isMe) {
